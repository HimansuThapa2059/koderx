  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        {/*color indicator */}
        <div
          className="relative w-4 h-4 rounded-full border brightness-75 border-gray-600 group-hover:border-gray-500 transition-colors"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-full min-w-[220px] bg-[#1e1e2e]/95 
